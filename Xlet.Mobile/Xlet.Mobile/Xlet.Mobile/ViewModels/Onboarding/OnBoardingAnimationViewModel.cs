...
using Xlet.Mobile.Models.Onboarding;
using Xlet.Mobile.Views.Onboarding;
using Syncfusion.SfRotator.XForms;
using Xamarin.Forms;
using Xamarin.Forms.Internals;
using Xlet.Mobile.Views.History;

namespace Xlet.Mobile.ViewModels.Onboarding
{
    /// <summary>
    ...
    public class OnBoardingAnimationViewModel : BaseViewModel
    {
        ...
        private void MoveToNextPage()
        {
            ...
            Application.Current.MainPage.Navigation.PushAsync(new TransactionHistoryPage()).Wait();
